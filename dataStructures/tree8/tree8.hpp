...
// Параметры:
// > T - указатель на дерево;
// > E - указатель на данные.
void writeDataTree(tree *T, tree8BaseType E);

// Чтение данных.
// Параметры:
// > T - указатель на дерево;
// > E - указатель на элемент, в который будут записаны данные.
...
// Параметры:
// > T_down - если не равен NULL, то указатель на дерево, из которого происходит
// переход;
// > T_up - если не равен NULL, то указатель на дерево, в которое происходит
// переход.
